...
// ============================================================
// 🧪 DEMO CONFIGURATION - Update these values for testing
// ============================================================
const DEMO_USER = {
  name: "Dhruv Shah",
  email: "dhruvsh2003@gmail.com",
};
// ============================================================
...
async function main() {
  ...
  console.log("🧪 VK Competition - Demo Email Test");
  console.log("=".repeat(50));
  console.log(`\n📧 Sending test email to: ${DEMO_USER.email}`);
  ...
  if (competitions.length === 0) {
    ...
    console.log("   Using placeholder data for demo...");
    
    // Fallback demo data if no competitions exist
    competitions.push({
      title: "AI Short Video Competition",
  ...
  try {
    ...
    console.log("\n" + "✅".repeat(25));
    console.log("✅ SUCCESS! Demo email sent!");
